...
namespace RetroCollector {
    public partial class EditConsoleForm : Form {
        ...
        public EditConsoleForm(UserAccount activeUser, ConsoleCategory selectedConsole = null) {
            InitializeComponent();
        ...
        private void ResetForm(ConsoleCategory console = null) {
            ...
            cboxConsoleDevelopers.SelectedItem = DatabaseManager.GetCompanyByName(console.Developer);
        ...
        private void OnSaveButtonClick(object sender, EventArgs e) {
            ...
            selectedConsole.Update(int.Parse(tboxConsoleId.Text), tboxConsoleName.Text, developer.Name);

            DatabaseManager.UpdateConsoleType(selectedConsole);
