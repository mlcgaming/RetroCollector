...
namespace RetroCollector {
    public partial class NewUserForm : Form {
        ...
        private void OnSaveButtonClick(object sender, EventArgs e) {
            ...
            UserAccount newUser = new UserAccount(int.Parse(tboxUserId.Text), tboxUserFirstName.Text, tboxUserLastName.Text, tboxUserLoginName.Text, passHash, passSalt, userRole.ID, DateTime.Now, DateTime.Now, activeUser.Username, activeUser.Username);

            DatabaseManager.AddNewUser(newUser);
