...
namespace RetroCollector {
    public partial class NewUserRoleForm : Form {
        ...
        private void OnSaveButtonClick(object sender, EventArgs e) {
            ...
            UserRole newRole = new UserRole(int.Parse(tboxUserRoleId.Text), tboxUserRoleName.Text, tboxUserRoleDescription.Text, permissions, DateTime.Now, DateTime.Now, activeUser.Username, activeUser.Username);

            DatabaseManager.AddNewUserRole(newRole);
